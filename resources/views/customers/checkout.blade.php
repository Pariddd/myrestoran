                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="form-item w-100">
                                ...
                                <input type="text" name="phone" class="form-control" placeholder="Masukkan no WA" required>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-4">
                            <div class="form-item w-100">
                                <label class="form-label my-3">Nomor Meja<sup>*</sup></label>
                                <input type="text" class="form-control"  value="{{ $tableNumber ?? 'Tidak ada no meja' }}" disabled required>
                            </div>
                        </div>
                    </div>   
                    <br>
            ...
            if(paymentMethod === "tunai") {
                ...
                .then(data => {
                    if(data.snap_token) {
                        ...
                        alert("Terjadi kesalahan, silakan coba lagi 222.");
                    }
                })
                .catch(error => {
                    console.error("Error:", error);
                    alert("Terjadi kesalahan, silakan coba lagi ya 22223.");
                });
            }
        })
    })
