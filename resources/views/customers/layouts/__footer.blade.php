        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-item">
                    ...
                    <p>Alamat:Banda Aceh, Lhoknga, Gp.KUEH</p>
                    <p>Email: farid.kurniawan0412@gmail.com</p>
                    <p>Telp: 0823-1820-4045</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>PARIDKUPI</a> <span id="currentYear"></span>. All right reserved.</span>
            </div>
